...
لهذا الإحباط صنعت **Panel 018**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **يعيد بناء الصورة بمرساة بصرية واحدة وطبقات قليلة وميكروتايب دقيق**.
